...
namespace Slapstick
{
    ...
    public class RetryScreen
    {
        ...
        {
            spriteBatch.DrawString(directionsFont, "Oh no! The celeb left!", new Vector2((1920 / 2) - (ohNoTextSize.X / 2), 300), Color.White, 0, new Vector2(1, 1), 1, SpriteEffects.None, 0);
            spriteBatch.DrawString(directionsFont, "Press Backspace to return to the main menu.", new Vector2((1920 / 2) - (returnTextSize.X / 2), 500), Color.White, 0, new Vector2(1, 1), 1, SpriteEffects.None, 0);
        }
